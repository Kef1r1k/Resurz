...
var airtable_umd = __webpack_require__(3829);
var airtable_umd_default = /*#__PURE__*/__webpack_require__.n(airtable_umd);
;// CONCATENATED MODULE: ./src/javascript/search-data.js

var token = 'pat57aWn58MOPVcsX.04a2b0042e59bb1d5e32ea99340b7ab2c84a35686b87b9758999ab0086789529';
airtable_umd_default().configure({
  endpointUrl: 'https://api.airtable.com',
  apiKey: token
});
var base = airtable_umd_default().base('appUdqJwOzvdKcNVq');
...
function filterArticles(articles, query) {
  ...
  return articles.filter(function (article) {
    return article.title && article.title.toLowerCase().includes(lowerQuery) || article.tags && article.tags.some(function (tag) {
...
function displayResults(articles) {
  var resultsContainer = document.querySelector('.C_Articles');
  var noResults = document.querySelector('.A_PageCover');
  ...
  articles.forEach(function (article) {
    var teaser = createTeaser(article);
...
function createTeaser(article) {
  ...
  var tagClass = article.style ? article.style.toLowerCase() : 'default';
  teaser.innerHTML = "\n        <div class=\"A_PostCover small\">\n            <img src=\"".concat(article.image, "\" alt=\"").concat(article.title, "\" />\n        </div>\n        <h5>").concat(article.title, "</h5>\n        <div class=\"C_Tags\">\n            ").concat(article.tags.map(function (tag) {
    return "<div class=\"A_Tag ".concat(tagClass, "\">").concat(tag, "</div>");
  }).join(''), "\n        </div>\n    ");
  return teaser;
}
...
function _performSearch() {
  _performSearch = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var loader, noResults, resultsContainer, articles, filteredArticles;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            loader = document.querySelector('.A_LoaderSpinner');
            loader.style.display = 'block';
            noResults = document.querySelector('.A_PageCover');
            noResults.style.display = 'none';
            resultsContainer = document.querySelector('.C_Articles');
            resultsContainer.style.display = 'none';
            resultsContainer.innerHTML = '';
            _context.prev = 7;
            _context.next = 10;
          ...
          case 10:
            ...
            filteredArticles = filterArticles(articles, getSearchQuery());
